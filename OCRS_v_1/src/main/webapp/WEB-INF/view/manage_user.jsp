			...
			<div id="templatemo_sidebar">
				...
				<div class="table_div" class="home">
					<table class="table_div">
						<tr>
							<td><p>
		<a href="${pageContext.request.contextPath}/showRegistrationForm?adminName=<security:authentication property="principal.username" />" >Add
			User</a>
	</p>
							...
							<td>
								<p>
		<a href="${pageContext.request.contextPath}/viewAllUser">View
			All User</a>
	</p>
							</td>
						</tr>
